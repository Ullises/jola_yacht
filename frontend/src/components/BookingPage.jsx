                      ...
                      >
                        <div className="flex items-center gap-2">
                          <svg viewBox="0 0 60 25" className="h-6" fill="#635bff">
                            <path d="M59.64 14.28h-8.06c.19 1.93 1.6 2.55 3.2 2.55 1.64 0 2.96-.37 4.05-.95v3.32a8.33 8.33 0 0 1-4.56 1.1c-4.01 0-6.83-2.5-6.83-7.48 0-4.19 2.39-7.52 6.3-7.52 3.92 0 5.96 3.28 5.96 7.5 0 .4-.02 1.04-.06 1.48zm-6.25-5.63c-1.03 0-1.95.68-2.18 2.32h4.23c-.09-1.54-.71-2.32-2.05-2.32zm-9.67 8.92V5.75h3.93l.29 1.36a4.57 4.57 0 0 1 3.81-1.71v3.95c-.32-.06-.68-.09-1.13-.09-1.16 0-2.24.4-2.88.95v7.36h-4.02zm-8.89-9.97c.55-.09 1.21-.14 1.85-.14.67 0 1.3.05 1.85.14v9.97H30.7zm1.85-4.9c1.31 0 2.38.9 2.38 2.01 0 1.11-1.07 2.01-2.38 2.01-1.31 0-2.38-.9-2.38-2.01 0-1.11 1.07-2.01 2.38-2.01zm-8.67 6.73c-.35-.93-1.33-1.62-2.72-1.62s-2.48.73-2.48 1.62c0 2.3 6.95 1.33 6.95 5.8 0 2.87-2.36 4.65-5.67 4.65-2.17 0-3.92-.63-5.13-1.92l1.37-2.9c.91 1.11 2.28 1.89 3.87 1.89 1.16 0 2.14-.5 2.14-1.46 0-2.6-6.92-1.37-6.92-5.91 0-2.82 2.27-4.74 5.54-4.74 1.92 0 3.62.58 4.78 1.66l-1.73 2.93zM8.33 17.57l-4.02-11.82h4.37l2.1 7.23 2.3-7.23h4.12l-4.37 11.82H8.33z"/>
                          </svg>
                        </div>
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <Button
                      ...
                      className={`flex-1 py-6 rounded-full text-white ${
                        paymentMethod === 'paypal' 
                          ? 'bg-[#003087] hover:bg-[#002369]' 
                          : 'bg-[#FF7F50] hover:bg-[#e66a3d]'
                      }`}
                    >
                      {submitting ? (
