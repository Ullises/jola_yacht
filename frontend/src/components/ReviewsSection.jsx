...
export const ReviewsSection = () => {
  ...
  const scrollContainer = (direction) => {
    if (direction === 'left') {
      ...
      setCurrentIndex(prev => Math.min(Math.max(0, reviews.length - 3), prev + 1));
    }
  };
          ...
          <div className="overflow-hidden px-3 -mx-3 py-4 -my-4">
            ...
            {loading ? (
              ...
              reviews.map((review, index) => (
                <div key={review.id} className="flex-none w-1/3 px-3">
                <div
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <img
                      src={review.avatar || `https://api.dicebear.com/9.x/personas/svg?seed=${encodeURIComponent(review.customer_name)}&backgroundColor=0F2C59`}
